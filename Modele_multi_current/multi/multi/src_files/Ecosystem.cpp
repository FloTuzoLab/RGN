...
DonutPuddle::DonutPuddle(int simulationNumber,
                         ...
                         Cell cell,
                         ofstream* fileoutcompartments,
                         ofstream* fileoutcells):
...
void DonutPuddle::DiffusionBetweenCompartments()
{
    ...
    for (int i=1;i<=m_lengthInside;i++)
    {
        ...
        {
            double concNutStand(OperatorFiniteDifferencesExplicit(m_alphaDF[0][0],m_alphaDF[0][1],conc[0][i][j],4,1,conc[0][m_neighbours[i][j][0][0]][m_neighbours[i][j][0][1]],conc[0][m_neighbours[i][j][1][0]][m_neighbours[i][j][1][1]],conc[0][m_neighbours[i][j][2][0]][m_neighbours[i][j][2][1]],conc[0][m_neighbours[i][j][3][0]][m_neighbours[i][j][3][1]],conc[0][0][0],0));
            
            double concNutHid(OperatorFiniteDifferencesExplicit(m_alphaDF[1][0],m_alphaDF[1][1],conc[1][i][j],4,1,conc[1][m_neighbours[i][j][0][0]][m_neighbours[i][j][0][1]],conc[1][m_neighbours[i][j][1][0]][m_neighbours[i][j][1][1]],conc[1][m_neighbours[i][j][2][0]][m_neighbours[i][j][2][1]],conc[1][m_neighbours[i][j][3][0]][m_neighbours[i][j][3][1]],conc[1][0][0],0));
            
            double concNutRev(OperatorFiniteDifferencesExplicit(m_alphaDF[2][0],m_alphaDF[2][1],conc[2][i][j],4,1,conc[2][m_neighbours[i][j][0][0]][m_neighbours[i][j][0][1]],conc[2][m_neighbours[i][j][1][0]][m_neighbours[i][j][1][1]],conc[2][m_neighbours[i][j][2][0]][m_neighbours[i][j][2][1]],conc[2][m_neighbours[i][j][3][0]][m_neighbours[i][j][3][1]],conc[2][0][0],0));
            
            double concComGoo(OperatorFiniteDifferencesExplicit(m_alphaDF[3][0],m_alphaDF[3][1],conc[3][i][j],4,1,conc[3][m_neighbours[i][j][0][0]][m_neighbours[i][j][0][1]],conc[3][m_neighbours[i][j][1][0]][m_neighbours[i][j][1][1]],conc[3][m_neighbours[i][j][2][0]][m_neighbours[i][j][2][1]],conc[3][m_neighbours[i][j][3][0]][m_neighbours[i][j][3][1]],conc[3][0][0],0));
    ...
    //cout << "conc post: " << m_puddle[1][1].GetConcentrationNutrientStandard() << endl;
}
...
FinitePuddle::FinitePuddle(int simulationNumber,
                           ...
                           Compartiment outsideCompartment,
                           int initialNumberCell,
                           Cell cell):
        Puddle(simulationNumber,
               cellSizerCycle,
...
/*
SeabedPuddle::SeabedPuddle(int simulationNumber,
                           bool cellSizerCycle,
                           double delta_t,
                           double delta_l,
                           int timeStepRatio,
                           ...
                           Compartiment insideCompartment,
                           Compartiment outsideCompartment,
                           Compartiment lateralCompartment,
                           int initialNumberCell,
                           Cell cell):
        Puddle(simulationNumber,
               cellSizerCycle,
