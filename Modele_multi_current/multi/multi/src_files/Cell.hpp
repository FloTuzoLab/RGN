    ...
    /* ###Methods### */
        ...
        /* ##Constructors## */
            ...
            Cell(double m_K__on,
                 ...
                 std::map <std::string,double> metaboliteCost,
        ...
        /* ##Other methods## */
            ...
            void Outputfilling(std::ofstream* &_fileoutcell);
            ...
            bool EnergyBudgetUsefulnessTest(double delta_t);
            /* #4.Energy production# */
            void EnergyProduction(bool energyWholeBudgetUsefulness,double delta_t);
            /* #5.Energy use# */
            void BasalMetabolismCalculus(double delta_t);
                // #i.Withdrawal by the basal metabolism
                void BasalMetabolismWithdrawal();
                    // #ii.a)Cell growth
                    void Growth(int totalNumberProteins,bool energyWholeBudgetUsefulness,double delta_t); //via phospholipids production
                    // #ii.b)Cell maintenance molecule production
                    void MaintenanceMetabolitesProduction(int totalNumberProteins,bool energyWholeBudgetUsefulness,double delta_t);
                    // #ii.c)Cell Public Goods production
                    void PublicGoodsMetabolitesProduction(int totalNumberProteins,bool energyWholeBudgetUsefulness,double delta_t);
                // #ii. Whole energy allocation process
                void EnergyBalance(bool energyWholeBudgetUsefulness,double delta_t);
...
private:
    ...
    /* 3.Proteins and metabolites dynamics */
        ...
        //iii.Metabolite
        double m_metaboliteGrowthProductionRate;
